...
2. You need to populate `server.conf` in this directory. You may use [this](server.conf) to get you started (valid for ghidra 11.1.2, for other versions... figure it out?)
